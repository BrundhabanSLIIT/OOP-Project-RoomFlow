...
<div class="container">
    <div class="card">
        ...
        <form action="/reservations" method="get" class="search-form">
            <input type="text" name="keyword" placeholder="Search by ID, customer, room, type, payment..." value="${keyword}">
        ...
        <div class="table-wrapper">
            <table>
                ...
                <c:choose>
                    <c:when test="${not empty reservations}">
                        <c:forEach var="reservation" items="${reservations}">
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="/reservations/edit/${reservation.reservationId}" class="btn btn-warning">Edit</a>
                    ...
                    <c:otherwise>
                        <tr>
                            <td colspan="11" class="empty-message">No reservations found.</td>
                        </tr>
                    </c:otherwise>
                </c:choose>
                </tbody>
