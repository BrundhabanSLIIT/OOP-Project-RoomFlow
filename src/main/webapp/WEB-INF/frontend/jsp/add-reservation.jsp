...
<head>
    ...
    <title>Add Reservation - RoomFlow</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav ms-auto align-items-center gap-1">
                ...
                <li class="nav-item"><a class="nav-link" href="/reservations"><i class="fa-solid fa-list me-1"></i>Reservations</a></li>
                <div class="rf-nav-divider d-none d-lg-block"></div>
                <li class="nav-item">
                    <a href="/reservations/add" class="btn btn-warning btn-sm fw-bold px-3 active">
                    ...
                    <form action="/reservations/add" method="post" id="reservationForm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control rf-input" name="reservationId"
                                       placeholder="e.g. RES001" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control rf-input" name="contactNumber"
                                       placeholder="10-digit number" pattern="[0-9]{10}" maxlength="10" required>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control rf-input" name="numberOfNights" min="1"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control rf-input" name="checkInDate" id="checkInDate" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">
                                    <i class="fa-solid fa-calendar-arrow-up me-1 text-danger"></i>Check-Out Date
                                </label>
                                <input type="date" class="form-control rf-input" name="checkOutDate" id="checkOutDate" required>
                            </div>
                        ...
                        <div class="d-flex gap-3 mt-4">
                            <button type="submit" class="btn rf-btn-save px-4">
                                <i class="fa-solid fa-floppy-disk me-2"></i>Save Reservation
                            </button>
